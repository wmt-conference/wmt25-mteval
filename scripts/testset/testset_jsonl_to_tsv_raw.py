...
ESA_LANGS = [("cs", "de_DE"), ("cs", "uk_UA"), ("en", "ar_EG"),
             ("en", "bho_IN"), ("en", "zh_CN"), ("en", "cs_CZ"),
             ("en", "et_EE"), ("en", "is_IS"), ("en", "it_IT"),
             ("en", "ja_JP"), ("en", "mas_KE"), ("en", "ru_RU"),
             ("en", "sr_Cyrl_RS"), ("en", "uk_UA")]
...
# MT systems that will be human-evaluated:
# NOTE: These are all approximate right now; the final decision isn't made!
EVALUATED_MTS = {
    make_lp_name("cs", "de_DE"): ['Algharb', 'AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'CUNI-MH-v2', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Laniqo', 'Llama-4-Maverick', 'Mistral-Medium', 'MMMT', 'Qwen3-235B', 'SalamandraTA', 'Shy', 'SRPOL', 'TowerPlus-72B', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("cs", "uk_UA"): ['Algharb', 'AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Laniqo', 'Llama-4-Maverick', 'Mistral-Medium', 'MMMT', 'SalamandraTA', 'Shy', 'SRPOL', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "ar_EG"): ['Algharb', 'AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'CommandR7B', 'DeepSeek-V3', 'EuroLLM-22B', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Mistral-Medium', 'MMMT', 'ONLINE-B', 'ONLINE-W', 'Shy', 'SRPOL', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "bho_IN"): ['Algharb', 'AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'COILD-BHO', 'CommandA', 'CommandA-MT', 'DeepSeek-V3', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GPT-4.1', 'IRB-MT', 'Llama-4-Maverick', 'Mistral-Medium', 'MMMT', 'NLLB', 'ONLINE-B', 'Qwen3-235B', 'SalamandraTA', 'Shy', 'TowerPlus-9B', 'TranssionMT', 'TranssionTranslate', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "zh_CN"): ['Algharb', 'Claude-4', 'CommandA', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Laniqo', 'Llama-4-Maverick', 'Mistral-Medium', 'MMMT', 'ONLINE-B', 'Qwen2.5-7B', 'Qwen3-235B', 'RuZh', 'Shy', 'SRPOL', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "cs_CZ"): ['Algharb', 'AyaExpanse-32B', 'Claude-4', 'CommandA', 'CommandA-MT', 'CUNI-MH-v2', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Laniqo', 'Mistral-Medium', 'MMMT', 'ONLINE-B', 'SalamandraTA', 'Shy', 'SRPOL', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "et_EE"): ['Algharb', 'Claude-4', 'CommandA-MT', 'EuroLLM-22B', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Laniqo', 'Llama-4-Maverick', 'MMMT', 'NLLB', 'ONLINE-B', 'ONLINE-W', 'SalamandraTA', 'Shy', 'SRPOL', 'TranssionTranslate', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "is_IS"): ['AMI', 'Claude-4', 'CommandA-MT', 'CommandR7B', 'DeepSeek-V3', 'Erlendur', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'IR-MultiagentMT', 'IRB-MT', 'Llama-3.1-8B', 'Llama-4-Maverick', 'Mistral-Medium', 'NLLB', 'ONLINE-B', 'SalamandraTA', 'Shy', 'TowerPlus-72B', 'TowerPlus-9B', 'TranssionTranslate', 'UvA-MT'],
    make_lp_name("en", "it_IT"): ['AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'CommandR7B', 'DeepSeek-V3', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Laniqo', 'Llama-3.1-8B', 'Mistral-Medium', 'ONLINE-B', 'ONLINE-W', 'Qwen2.5-7B', 'Qwen3-235B', 'SalamandraTA', 'Shy', 'TowerPlus-72B', 'TowerPlus-9B', 'TranssionTranslate', 'UvA-MT'],
    make_lp_name("en", "ja_JP"): ['Algharb', 'bb88', 'Claude-4', 'CommandA', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'GemTrans', 'GPT-4.1', 'In2x', 'IRB-MT', 'KIKIS', 'Laniqo', 'Mistral-Medium', 'MMMT', 'NTTSU', 'ONLINE-B', 'Qwen3-235B', 'Shy', 'SRPOL', 'Systran', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "mas_KE"): ['AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'CommandR7B', 'DeepSeek-V3', 'EuroLLM-22B', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'IR-MultiagentMT', 'IRB-MT', 'Llama-3.1-8B', 'Mistral-7B', 'NLLB', 'Qwen2.5-7B', 'Shy', 'TowerPlus-72B', 'TowerPlus-9B', 'TranssionMT'],
    make_lp_name("en", "ru_RU"): ['Algharb', 'Claude-4', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Laniqo', 'MMMT', 'Qwen3-235B', 'RuZh', 'SalamandraTA', 'Shy', 'SRPOL', 'TowerPlus-72B', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yandex', 'Yolu'],
    make_lp_name("en", "sr_Cyrl_RS"): ['AyaExpanse-8B', 'Claude-4', 'CommandA-MT', 'CommandR7B', 'CUNI-SFT', 'DeepSeek-V3', 'DLUT_GTCOM', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'IR-MultiagentMT', 'IRB-MT', 'Llama-3.1-8B', 'Llama-4-Maverick', 'Mistral-7B', 'NLLB', 'ONLINE-B', 'ONLINE-G', 'Qwen3-235B', 'SalamandraTA', 'Shy', 'TowerPlus-9B', 'TranssionTranslate', 'UvA-MT'],
    make_lp_name("en", "uk_UA"): ['Algharb', 'CGFOKUS', 'Claude-4', 'CommandA', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Laniqo', 'Llama-4-Maverick', 'Mistral-Medium', 'MMMT', 'SalamandraTA', 'Shy', 'SRPOL', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "ko_KR"): ['Algharb', 'AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'CommandR7B', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'GemTrans', 'GPT-4.1', 'IRB-MT', 'Laniqo', 'Llama-4-Maverick', 'Mistral-Medium', 'MMMT', 'ONLINE-B', 'Qwen3-235B', 'Shy', 'TowerPlus-72B', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("ja", "zh_CN"): ['Algharb', 'bb88', 'Claude-4', 'CommandA', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'GemTrans', 'GPT-4.1', 'In2x', 'IRB-MT', 'Kaze-MT', 'Laniqo', 'Mistral-Medium', 'MMMT', 'NTTSU', 'Qwen2.5-7B', 'Qwen3-235B', 'Shy', 'SRPOL', 'TowerPlus-72B', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu']
}
    ...
    with open(filename, encoding="utf-8") as fh:
        for line in fh:
            ...
            for i in range(len(src_texts)):
                ...
                rt = trim_and_escape(ref_texts[i]) if ref_texts else "NaN"
...
def unify_src_hyp(src_segs_by_lp_and_doc, hyp_docs_by_lp, system_id):
    ...
    for lp in hyp_docs_by_lp:
        # We don't want non-human-evaluated systems in the test set:
        if system_id not in EVALUATED_MTS[lp]:
            sys.stderr.write(f"Skipping {lp} because {system_id} won't be evaluated on it\n")
            continue
...
def trim_and_escape(text):
    fixed = text.replace("\t", " ").replace("\r", " ").strip()
