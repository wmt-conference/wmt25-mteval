...
EVALUATED_MTS = {
    make_lp_name("cs", "de_DE"): ["Algharb", "AyaExpanse-32B", "Claude-4", "CommandA", "CommandA-MT", "DeepSeek-V3", "Gemini-2.5-Pro", "Gemma-3-12B", "Gemma-3-27B", "GemTrans", "GPT-4.1", "hybrid", "HYT", "IRB-MT", "Laniqo", "Llama-4-Maverick", "Mistral-Medium", "MMMT", "Shy", "SRPOL", "TMTHY", "TowerPlus-72B", "TowerPlus-9B", "UvA-MT", "Wenyiil", "Yolu"],
    make_lp_name("cs", "uk_UA"): ["Algharb", "AyaExpanse-32B", "Claude-4", "CommandA", "CommandA-MT", "DeepSeek-V3", "Gemini-2.5-Pro", "Gemma-3-12B", "Gemma-3-27B", "GemTrans", "GPT-4.1", "hybrid", "HYT", "IRB-MT", "Laniqo", "Llama-4-Maverick", "Mistral-Medium", "MMMT", "Shy", "SRPOL", "TMTHY", "TowerPlus-9B", "UvA-MT", "Wenyiil", "Yolu"],
    make_lp_name("en", "ar_EG"): ['Algharb', 'AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'CommandR7B', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Mistral-Medium', 'MMMT', 'ONLINE-B', 'Shy', 'SRPOL', 'TMTHY', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "bho_IN"): ['Algharb', 'Claude-4', 'COILD-BHO', 'CommandA', 'CommandA-MT', 'DeepSeek-V3', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-27B', 'GPT-4.1', 'hybrid', 'Llama-4-Maverick', 'Mistral-Medium', 'MMMT', 'NLLB', 'ONLINE-B', 'SalamandraTA', 'Shy', 'TMTHY', 'TowerPlus-9B', 'TranssionMT', 'TranssionTranslate', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "zh_CN"): ['Algharb', 'Claude-4', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Laniqo', 'Llama-4-Maverick', 'Mistral-Medium', 'MMMT', 'ONLINE-B', 'Qwen2.5-7B', 'Qwen3-235B', 'RuZh', 'Shy', 'SRPOL', 'TMTHY', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "cs_CZ"): ['Algharb', 'Claude-4', 'CommandA', 'CommandA-MT', 'CUNI-MH-v2', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Laniqo', 'Mistral-Medium', 'MMMT', 'SalamandraTA', 'Shy', 'SRPOL', 'TMTHY', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "et_EE"): ['Algharb', 'Claude-4', 'CommandA-MT', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Laniqo', 'MMMT', 'ONLINE-B', 'SalamandraTA', 'Shy', 'SRPOL', 'TMTHY', 'TranssionTranslate', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "is_IS"): ['AMI', 'Claude-4', 'CommandA-MT', 'DeepSeek-V3', 'Erlendur', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Llama-3.1-8B', 'Llama-4-Maverick', 'NLLB', 'ONLINE-B', 'SalamandraTA', 'Shy', 'TMTHY', 'TowerPlus-72B', 'TowerPlus-9B', 'TranssionTranslate', 'UvA-MT'],
    make_lp_name("en", "it_IT"): ['AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'CommandR7B', 'DeepSeek-V3', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Laniqo', 'Mistral-Medium', 'ONLINE-B', 'ONLINE-W', 'Qwen3-235B', 'SalamandraTA', 'Shy', 'TMTHY', 'TowerPlus-72B', 'TowerPlus-9B', 'UvA-MT'],
    make_lp_name("en", "ja_JP"): ['Algharb', 'bb88', 'Claude-4', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'In2x', 'KIKIS', 'Laniqo', 'Mistral-Medium', 'MMMT', 'NTTSU', 'ONLINE-B', 'Shy', 'Systran', 'TMTHY', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "mas_KE"): ['AyaExpanse-32B', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'CommandR7B', 'DeepSeek-V3', 'EuroLLM-22B', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'hybrid', 'HYT', 'IR-MultiagentMT', 'IRB-MT', 'Llama-3.1-8B', 'Mistral-7B', 'NLLB', 'Qwen2.5-7B', 'Shy', 'TMTHY', 'TowerPlus-72B', 'TowerPlus-9B', 'TranssionMT'],
    make_lp_name("en", "ru_RU"): ['Algharb', 'Claude-4', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Laniqo', 'MMMT', 'Qwen3-235B', 'RuZh', 'SalamandraTA', 'Shy', 'SRPOL', 'TMTHY', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yandex', 'Yolu'],
    make_lp_name("en", "sr_Cyrl_RS"): ['Claude-4', 'CommandA-MT', 'CUNI-SFT', 'DeepSeek-V3', 'DLUT_GTCOM', 'EuroLLM-9B', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'Gemma-3-27B', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Llama-3.1-8B', 'Llama-4-Maverick', 'NLLB', 'ONLINE-B', 'Qwen3-235B', 'SalamandraTA', 'Shy', 'TMTHY', 'TowerPlus-9B', 'TranssionTranslate', 'UvA-MT'],
    make_lp_name("en", "uk_UA"): ['Algharb', 'Claude-4', 'CommandA', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Laniqo', 'Mistral-Medium', 'MMMT', 'SalamandraTA', 'Shy', 'SRPOL', 'TMTHY', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("en", "ko_KR"): ['Algharb', 'AyaExpanse-8B', 'Claude-4', 'CommandA', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'Gemma-3-12B', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'IRB-MT', 'Laniqo', 'Mistral-Medium', 'MMMT', 'ONLINE-B', 'Qwen3-235B', 'Shy', 'TMTHY', 'TowerPlus-72B', 'TowerPlus-9B', 'UvA-MT', 'Wenyiil', 'Yolu'],
    make_lp_name("ja", "zh_CN"): ['Algharb', 'bb88', 'Claude-4', 'CommandA-MT', 'DeepSeek-V3', 'Gemini-2.5-Pro', 'GemTrans', 'GPT-4.1', 'hybrid', 'HYT', 'In2x', 'IRB-MT', 'Kaze-MT', 'Laniqo', 'Mistral-Medium', 'MMMT', 'NTTSU', 'Qwen2.5-7B', 'Qwen3-235B', 'Shy', 'TMTHY', 'TowerPlus-9B', 'Wenyiil', 'Yolu']
}
...
def trim_and_escape(text):
    fixed = text.strip().replace("\t", " ").replace("\r", " ")
